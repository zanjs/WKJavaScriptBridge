...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "http://EXAMPLE/jsbridge"
  ...
  spec.author             = { "suihua" => "suihuasheng@gmail.com" }
  # Or just: spec.author    = "suihua"
  # spec.authors            = { "suihua" => "suihuasheng@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/suihua"
  ...
  spec.source       = { :git => "http://EXAMPLE/jsbridge.git", :tag => "#{spec.version}" }
